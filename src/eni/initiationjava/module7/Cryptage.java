...
public class Cryptage {
    public static void main(String[] args) {
        ...
        System.out.print("Entrez une phrase à encoder (en majuscule) : ");
        String toEncode = askInput.nextLine().toUpperCase(); // On s'assure que les lettres soient en majuscules.
        String encodeKey;
        do {
            System.out.print("Entrez une clé de cryptage valide : ");
            encodeKey = askInput.nextLine();
        } while (!keyValidity(encodeKey));
        System.out.println(encodeString(toEncode, encodeKey));
    }
